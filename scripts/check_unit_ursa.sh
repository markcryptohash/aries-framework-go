...
# Current CI uses ghcr.io/markcryptohash/ursa-wrapper-go/uwg-build.

 # Running aries-framework-go unit test with ursa
PKGS=$(go list -tags ursa github.com/markcryptohash/aries-framework-go/pkg/... 2> /dev/null | grep -v /mocks | grep -v /aries-js-worker)
